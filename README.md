...
Развернута база на собственном сервере в докер (конфиги в проекте)
...
В единицу времени данных немного, обновляются не быстро, принебрег стейджем, но перевел сам Excel на порционную загрузку с проверкой файлов, преобразованием, валидация данных и без дублирование загрузки


Система Visiology несколько глючная, несколько раз терял часть несохранненного дела,
